            ...
            <div className={`${classes.banner} mx-auto flex flex-row items-center justify-center text-center w-full`}>
                ...
                <div>
                    ...
                    <div className={`${classes.ctaButtons} flex items-center justify-center gap-4 mt-4`}>
                        ...
                        <Link href={'https://forms.gle/t6MPdQcKurSAVDbs7'} target='_blank' className="text-center relative rounded-full w-40 px-6 py-4 text-white text-xs font-bold uppercase bg-[#0842a0] hover:bg-[#2958a4] transition duration-200 ease-in-out overflow-hidden">
                            Let's talk
                        </Link>
                    </div>
