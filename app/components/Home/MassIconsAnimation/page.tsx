...
export default function MassIconsAnimation() {
    ...
    return (
        <>
            ...
            <div id='about' className="relative top-[19rem] flex flex-row gap-[3rem] rounded-t-[5rem] pt-[4rem] h-[50rem]">
                {/* <div className={`lines`}>
                ...
                <div className="mx-[5rem] flex flex-col gap-[4rem] relative w-full">
                    <div className='flex flex-col gap-2 items-start '>
                        <section>
                            <h2 className='flex flex-col products-title text-left font-[300] text-[#fff] mx-auto gap-2' style={{ lineHeight: '1.04', letterSpacing: '-.04em', fontSize: 'clamp(2.5rem,calc(3.8095vw + 1.5714rem),4rem)', textWrap: 'balance' }}>
                                <div>
                                    <span>
                                        About Us. <span className='gradient-text'>All-in-One</span> <br /> Digital Expertise.
                                    </span>
                                </div>
                            </h2>
                        </section>
                        <p className='richtext text-[16px] text-gray-400 max-w-[36rem] mt-4'>At WeDev, we transform concepts into powerful digital solutions. With expertise in design and development, we help businesses create experiences that engage and perform.</p>
                    </div>
                    <div className='flex flex-row items-center gap-[4rem]'>
                        <div className='flex flex-col gap-2 items-start max-w-[35rem] border-t border-[#13293E] pt-[8px] '>
                            <h4 className='text-[17px] font-semibold text-[#3e6af0] flex flex-row items-center gap-1'>
                                <svg width={'17'} height={'17'} fill="#3e6af0" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 576 512">
                        ...
                        <div className='flex flex-col gap-2 items-start max-w-[35rem] border-t border-[#13293E] pt-[8px] '>
                            <h4 className='text-[17px] font-semibold text-[#3e6af0] flex flex-row items-center gap-1'>
                                <svg width={'17'} height={'17'} fill="#3e6af0" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512">
                    ...
                    <div className='max-w-[33rem] text-gray-300 pl-[25px] border-l border-[#0842a0]' style={{ borderLeftWidth: '3px' }}>
                    ...
                    <div className={`${classes.flyingImages}  absolute right-0 top-[3rem] flex flex-col items-center justify-center gap-[6rem]`}>
                        ...
                        <div style={{ animation: '3s ease 0s infinite normal none running bounce2' }} className='absolute left-[-29rem] top-[19rem] flex flex-col gap-[3.24rem] items-center justify-center shadow-2xl'>
                            <div className="w-[190px] rounded-2xl bg-[#282a2c] absolute left-[-6rem] top-16 flex flex-col gap-1 z-20 p-[18px]">
