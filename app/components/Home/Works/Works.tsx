export default function Services() {
    return (
        <div id="works" className="relative top-[29rem] mt-[2rem] overflow-hidden px-[5rem]">
            <div className={`lines`}>
                ...
                <div className="flex flex-col items-start justify-start gap-[7rem] w-full">
                    <div className={` work w-full flex flex-row items-center justify-between relative overflow-hidden`}>
                        <div className="flex flex-col gap-[15px]">
                            ...
                            <h2 className='flex flex-col products-title font-[500] text-[#fff] text-left mx-auto gap-2' style={{ lineHeight: '1.3', letterSpacing: '-.04em', fontSize: 'clamp(2.5rem,calc(3.8095vw + 1.5714rem),1rem)', textWrap: 'balance' }}>
                                <div>
                                    <span>
                            ...
                            <div className="flex flex-row items-center gap-[10px] mt-[5px]">
                                <div className="border-2 border-[#418acd] rounded-md text-[11px] px-[8px] py-[6px] font-[300]">
                                    Django
                                </div>
                                <div className="border-2 border-[#418acd] rounded-md text-[11px] px-[8px] py-[6px] font-[300]">
                                    HTML
                    ...
                    <div className={` work w-full flex flex-row items-center justify-between relative overflow-hidden`}>
                        <div className="flex flex-col gap-[15px]">
                            ...
                            <h2 className='flex flex-col products-title font-[500] text-[#fff] text-left gap-2' style={{ lineHeight: '1.3', letterSpacing: '-.04em', fontSize: 'clamp(2.5rem,calc(3.8095vw + 1.5714rem),1rem)', textWrap: 'balance' }}>
                                <div>
