...
export default function InfoSection(props: any) { 
    return (
        <div id='career' className="px-[5rem] relative">
            <div className={`bg-[#ffffff0a] border-2 border-[#3e6af0] top-[80rem] mx-auto flex flex-row items-center rounded-2xl p-[4rem] justify-between relative overflow-hidden`}>
                <div className='flex flex-col gap-3'>
                    ...
                    <section>
                        <h2 className='flex flex-col products-title text-left font-[300] text-[#fff] mx-auto gap-2' style={{ lineHeight: '1.04', letterSpacing: '-.04em', fontSize: 'clamp(2.5rem,calc(3.8095vw + 1.5714rem),1rem)', textWrap: 'balance' }}>
                            <div>
                                <span>
                                    Join our team at <span className='gradient-text'>WeDev</span>
                                </span>
                            </div>
                        </h2>
                    </section>
                    ...
                    <Link href={'https://forms.gle/k4ZHH5KMSh2hJuhv6'} target='_blank' className="mt-4 duration-200 w-[200px] transition ease-in-out bg-[#0842a0] flex flex-row justify-center items-center gap-1 font-semibold inline-block px-4 py-[19px] font-medium rounded-full text-xs z-20">
                        <span className='capitalize text-[18px] text-gray-200'>Apply Now</span>
                    </Link>
