...
export default function Footer() { 
    return (
        <footer className={`${classes.footer} relative`}>
                ...
                <div className="grid grid-cols-1 gap-6 sm:grid-cols-2 sm:gap-y-10 lg:grid-cols-4">
                    <div className="sm:col-span-2 flex flex-col gap-8">
                        ...
                        <div className="flex items-center gap-6 -mx-2">
                            <a href="https://www.instagram.com/wedevv/" target='_blank' className="mx-2 text-gray-600 transition-colors duration-300 dark:text-gray-300 hover:text-blue-500 dark:hover:text-blue-400" aria-label="Github">
                            ...
                            <a href='https://discord.gg/XtHa2AbW' target='_blank' className="mx-2 text-gray-600 transition-colors duration-300 dark:text-gray-300 hover:text-blue-500 dark:hover:text-blue-400" aria-label="Github">
            ...
            <div className={`${classes.footerGradient}`}></div>
        </footer>
    )
}